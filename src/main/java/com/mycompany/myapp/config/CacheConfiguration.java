        ...
        if (this.registration == null) { // if registry is not defined, use native discovery
            ...
            return () ->
                GlobalConfigurationBuilder
                    ...
                    .defaultCacheName("infinispan-jhipsterSampleApplication-cluster-cache")
                    .transport()
                    .defaultTransport()
                    .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                    .clusterName("infinispan-jhipsterSampleApplication-cluster")
                    .jmx()
        ...
        return manager -> {
            ...
            manager.defineConfiguration(
                ...
                new ConfigurationBuilder()
                    ...
                    .size(cacheInfo.getLocal().getMaxEntries())
                    .expiration()
            ...
            manager.defineConfiguration(
                ...
                new ConfigurationBuilder()
                    ...
                    .memory()
                    .evictionType(EvictionType.COUNT)
                    .size(cacheInfo.getDistributed().getMaxEntries())
                    .expiration()
            ...
            manager.defineConfiguration(
                ...
                new ConfigurationBuilder()
                    ...
                    .memory()
                    .evictionType(EvictionType.COUNT)
                    .size(cacheInfo.getReplicated().getMaxEntries())
                    .expiration()
